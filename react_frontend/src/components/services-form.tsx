...
const ServicesForm = ({services, success}: ServicesPageProps): React.ReactElement => {
    const {
        hostname, ntp_server, utc_offset, ntp_dst, mqtt_ip_address, mqtt_port, mqtt_user, mqtt_password, mqtt_qos,
        enable_ntp, enable_mqtt, ota_url } = services;
        ...
        <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
            <div className="flex flex-row gap-4 mb-4">
                <div className="w-full">
                    ...
                    <Input
                        ...
                        {...register("hostname")}
                    />
                    {errors.hostname && <p role="alert" className="text-red-800">{errors.hostname?.message}</p>}
                </div>
            </div>
            ...
            <div className="text-gray-500 flex flex-row gap-4 pb-1">
                <Controller
                    ...
                    control={control}
                    render={({ field }) =>
                        <Switch id="enable-ntp" checked={field.value} onCheckedChange={field.onChange} />}
                />
            ...
            <div className="flex flex-row gap-4 mb-4">
                <div className="w-[30%]">
                    ...
                    <Input
                        ...
                        {...register("ntp_server")}
                    />
                    {errors.ntp_server && <p role="alert" className="text-red-800">{errors.ntp_server?.message}</p>}
                </div>
                ...
                <div className="w-[30%]">
                    ...
                    />
                    {errors.utc_offset && <p role="alert" className="text-red-800">{errors.utc_offset?.message}</p>}
                </div>

                <div className="w-[30%] flex flex-col gap-2 items-center">
                    <div className="text-gray-500">
                        <Label className="text-sm" htmlFor="dst-mode">Daylight save</Label>
                    </div>
                    <Controller
                        name="ntp_dst"
                        control={control}
                        render={({ field }) =>
                            <Switch id="dst-mode" checked={field.value} onCheckedChange={field.onChange} />}
                    />
                </div>
            </div>
            ...
            <div className="text-gray-500 flex flex-row gap-4 pb-1">
                <Controller
                    ...
                    control={control}
                    render={({ field }) =>
                        <Switch id="enable-mqtt" checked={field.value} onCheckedChange={field.onChange} />}
                />
            ...
            <div className="flex flex-row gap-4 mb-4">
                <div className="w-auto">
                    ...
                    />
                    {errors.mqtt_ip_address && <p role="alert" className="text-red-800">{errors.mqtt_ip_address?.message}</p>}
                </div>
                <div className="w-auto">
                    <div className="text-gray-500 pb-1">
                    ...
                    <Input
                        ...
                        {...register("mqtt_port")}
                    />
                    {errors.mqtt_port && <p role="alert" className="text-red-800">{errors.mqtt_port?.message}</p>}
                </div>
                <div className="w-auto">
                    <div className="text-gray-500 pb-1">
                    ...
                    />
                    {errors.mqtt_qos && <p role="alert" className="text-red-800">{errors.mqtt_qos?.message}</p>}
                </div>
            </div>
            ...
            <div className="flex flex-row gap-4 mb-4">
                <div className="w-[50%]">
                    ...
                    <Input
                        ...
                        {...register("mqtt_user")}
                    />
                    {errors.mqtt_user && <p role="alert" className="text-red-800">{errors.mqtt_user?.message}</p>}
                </div>
                <div className="w-[50%]">
                    <div className="text-gray-500 pb-1">
                    ...
                    />
                    {errors.mqtt_password && <p role="alert" className="text-red-800">{errors.mqtt_password?.message}</p>}
                </div>
            </div>
            ...
            <div className="w-full">
                ...
                <Input
                    type="string"
                    placeholder="http://10.0.0.10/ota"
                    {...register("ota_url")}
                />
                {errors.ota_url && <p role="alert" className="text-red-800">{errors.ota_url?.message}</p>}
            </div>
