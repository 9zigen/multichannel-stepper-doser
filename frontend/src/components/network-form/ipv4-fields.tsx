...
import { LockKeyhole, Router, ScanSearch, Signal, WifiHigh } from 'lucide-react';
      ...
      {isWifi ? (
        <>
          ...
          <div className="rounded-lg border border-border/40 bg-secondary/10 p-3">
            ...
            <ScrollArea className="max-h-48 rounded-md border border-border/30 bg-background/50">
